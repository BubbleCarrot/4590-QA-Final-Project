            ...
            <div class="grid grid-cols-12 py-10">
                <div class="col-span-12">
                    ...
                    <div class="mb-4 pb-6">
                        ...
                        <input class="rounded w-full py-2 px-3 text-gray-700" id="" type="name" name="name" placeholder="full name">
                    </div> 
                    
                    <div class="mb-4 pb-6">
                        <label class="block text-sm font-bold mb-2" for="" >Email</label>
                        <input class="rounded w-full py-2 px-3 text-gray-700" id="" type="email" name="email" placeholder="email">
                    </div>   

                    <div class="mb-4 pb-6">
                        <label class="block text-sm font-bold mb-2" for="" >Phone Number</label>
                        <input class="rounded w-full py-2 px-3 text-gray-700" id="" type="email" name="email" placeholder="phone number">
                    </div>   
