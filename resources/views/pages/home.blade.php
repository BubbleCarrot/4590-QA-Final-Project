...
@section('content')
<main>
    <section id="top" class="banner items-center">
        <img src="images/banner-logo.png" alt="Logo goes here">
    </section>
    <section class="services pb-20 pt-10">
        <h1 class="text-center pb-8">Our Services</h1>
        <div class= "flex justify-center">
            <div class="flex">
                <div class="service-imgs px-5">
                    <a href="#">
                        <img class="card-1" src="images/physical.png" alt="#">
                        <p class="text-img">Physical Therapy</p>
                    </a>
                </div>
                <div class="service-imgs px-5">
                    <a href="">
                        <img class="card-2" src="images/chiro.png" alt="#">
                        <p class="text-img">Chiropractor Treatment</p>
                    </a>
                </div>
                <div class="service-imgs px-5">
                    <a href="#">
                        <img class="card-3" src="images/speech.jpg" alt="#">
